#--------------------------------------------------------------------------
# Version 1.0
# By Shiva Najafian, AmirKabir University of Technology
# Based on Dr Anthony Nash works
#-------------------------------------------------------------------------
...
print "\n";
print "\t\t\tBilayer Water Removal Tool for Gromacs (5.x.x) files\n";
print "\t\t\tBy Shiva Najafian - Version $version\n";
print "*************************************************************************************\n\n";
...
if(($ARGV[0] eq "-h") && (@ARGV == 1)) {
    ...
    print "!!!!!!!!!!!!!!!First enter gromacs source then use this file!!!!!!!!!!!\n";
    print "e.g. source /usr/local/gromacs/bin/GMXRC\n";
    print "perl water_deletor_shiva.pl inputfile.gro outputfile.gro z1 z2 n\n";
...
my $run9 = system("gmx editconf -quiet -f updated_water.gro -o $outputFile");
if($run9 != 0) {
